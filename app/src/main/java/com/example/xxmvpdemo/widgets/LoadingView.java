package com.example.xxmvpdemo.widgets;
...
public class LoadingView extends ConstraintLayout {
    ...
    public static LoadingView inject(ViewGroup parent) {
        ...
        LoadingView loadingView = (LoadingView) LayoutInflater.from(parent.getContext()).inflate(R.layout.layout_loading_view, parent, false);
